...
RUN apk --no-cache add bash && \
    ...
    /bin/bash -c "source $HOME/.sdkman/bin/sdkman-init.sh && sdk selfupdate && sdk install java 17 && sdk install gradle $GRADLE_VERSION && sdk flush archives && sdk flush temp"
